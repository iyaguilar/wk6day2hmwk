from flask import Flask, Blueprint, flash, redirect, request, render_template, \
    request, url_for
import requests

from blueprints.auth.forms import PokemonForm, LoginForm, SignupForm
...
from blueprints.auth.routes import login
